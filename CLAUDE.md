...
| 2026-05-20 | Fix workflow page: sample queries → Korean supported workflow; unsupported_workflow shown as structured error with guidance; colors/sizes improved |
